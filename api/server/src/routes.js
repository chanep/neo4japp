...
router.get('/external-service/approver/:approverId/myTeam', security.checkAccessKey(config.serviceAccessKey), approverController.findDirectReports.bind(approverController));
