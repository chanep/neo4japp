              ...
              'gtm.element': this})}}>
                  ...
                  <div className="header-menu">
                    ...
                    <div className="header-menu__item-list">
                      ...
                      {this.base.EmployeeHasAnyRole(['admin','approver','employee']) ? <a className="header_menu_item" href={'http://square/people/' + this.state.userLogged.username + '/'} target="_blank">My Portfolio</a> : null}
