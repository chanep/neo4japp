    ...
    render() {
        ...
        return (
            <div className="row-add-skill">
                <div className="grid">
                    <div className="col -col-4 -col-name overflowHidden" title={this.state.data.name}>{this.state.data.name}</div>
                    <div className="col -col-4 overflowHidden" title={this.state.parent.name}>{this.state.parent.name}</div>
                    <div className="col -col-3">{this.state.data.skills.length}</div>
