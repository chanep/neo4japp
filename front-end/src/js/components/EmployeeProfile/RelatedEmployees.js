    ...
    render() {
    	...
    	return (
    		<div className="employee-related-employees">
                {this.state.areaCoordinator !== undefined && this.state.areaCoordinator !== null && this.state.areaCoordinator.hasOwnProperty('id') ?
                    <RelatedEmployee user={this.state.areaCoordinator} />
                : null }
                {this.state.resourceManager !== undefined && this.state.resourceManager !== null && this.state.resourceManager.hasOwnProperty('id') ?
                    <RelatedEmployee user={this.state.resourceManager} />
                : null }
                {basePage.ResourceManagerLoggedIn() && this.state.currentSimilarSkilledUser !== undefined && this.state.currentSimilarSkilledUser !== null && this.state.currentSimilarSkilledUser.hasOwnProperty('id')?
