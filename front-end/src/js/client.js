...
ReactDOM.render(
	<Router history={hashHistory}>
        ...
        <Route path="/searchresults" component={SearchResults}>
             ...
             <Route path="/searchresults/clients/:clientsIds" component={SearchResults}/>
             ...
             <Route path="/searchresults/clients/:clientsIds/locations/:locationsIds" component={SearchResults}/>
             ...
             <Route path="/searchresults/skills/:skillsIds/clients/:clientsIds" component={SearchResults}/>
             <Route path="/searchresults/skills/:skillsIds/clients/:clientsIds/locations/:locationsIds" component={SearchResults}/>
             <Route path="/searchresults/interests/:interests/clients/:clientsIds" component={SearchResults}/>
             <Route path="/searchresults/interests/:interests/clients/:clientsIds/locations/:locationsIds" component={SearchResults}/>
             <Route path="/searchresults/skills/:skillsIds/interests/:interestsIds/clients/:clientsIds" component={SearchResults}/>
             <Route path="/searchresults/skills/:skillsIds/interests/:interestsIds/clients/:clientsIds/locations/:locationsIds" component={SearchResults}/>
        </Route>
