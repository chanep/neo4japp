                ...
                <div className="faq">
                    ...
                    <div className="faq-content">
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>What is SkillSearch?</h4>
                        ...
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>How do I get a SkillSearch Profile?</h4>
                            <div className="faq-entry-content"><p>You already have one! You have to be on a R/GA servers to access the platform. The site url is: http://skillsearch/. Use your R/GA username and password to log in.</p></div>
                        </article>
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>Do I have to do this?</h4>
                        ...
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>What do the skill levels mean?</h4>
                        ...
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>Who sees my skills?</h4>
                         ...
                         <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>In the menu, what is “Your work?”</h4>
                        ...
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>What’s Next?</h4>
                        ...
                        <article className="faq-entry">
                            <h4 className="faq-entry-title close-entry open-entry"><span></span>I still have a question.</h4>
